...
2. Marie Curie was born on 07.11.1867.
3. Marie Curie discovered Radium.
4. Radium is a chemical element.
5. Marie Curie is the same person as `<http://dbpedia.org/resource/Marie_Curie>`.
...
```turtle
:Professor rdf:type ___ .
:teachesCourse rdf:type rdfs:Property .
:teachesCourse rdfs:domain ___ .
:teachesCourse rdfs:range ___ .
:teachesCourse ___ :instructs .
```
